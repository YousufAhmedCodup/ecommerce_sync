<template>
    <div class="wrapper-stepper">
        <div class="stepper">
            ...
            <div class="stepper-item" :class="{ 'current': step == item, 'success': step > item }" v-for="item in 5"
                :key="item">
        ...
        <div class="stepper-content">
            ...
            <div class="stepper-pane" v-if="step == 5">
                <h1 class="text-xl text-center">You're flow is ready to launch</h1>
                <!-- Estas en el paso <span class="tx-green-1">{{ item }}</span> aqui mostrarás el contenido :D -->
            </div>
        </div>
        ...
        <div class="controls">
            ...
            <button class="btn btn--green-1" @click="step++" :disabled="step == 5" :class="{ 'hidden': step == 5 }">
                Next
            </button>
            <router-link class="btn btn--green-1" :class="{ 'hidden': step != 5, 'block': step == 5 }" to="/dashboard/flow">
                <button>
                    Launch
                </button>
            </router-link>
