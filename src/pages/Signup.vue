        ...
        <div class='containerss'>
            <div class='window'>
                ...
                <div class='content'>
                    ...
                    <div class='spacing'>Do you have an Account? <router-link to="/"> <span
                                class='highlight'>Login</span></router-link></div>
                    <div><button class='ghost-round full-width'><router-link to="/"> <span class='highlight'>Sign
                                    Up</span></router-link></button></div>
                </div>
            </div>
        </div>
    </div>
...
.overlay {
    background: -webkit-linear-gradient(#4c87ff, #0a0a0a);
    background: linear-gradient(#4c87ff, #0a0a0a);
    opacity: 0.85;
